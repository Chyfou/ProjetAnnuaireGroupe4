package fri.isika.cda26.project1.groupe4.frontpackage.constants;
...
public interface FrontConstants {
	...
	int COLUMN_INTERN_WIDTH = (STAGE_WIDTH - LEFT_PANNEL_WIDTH) / 5;
	int COLUMN_USER_WIDTH = (STAGE_WIDTH - LEFT_PANNEL_WIDTH) / 4;
	...
	int VBOX_SPACING = 40;
	int TEXT_FIELDS_WIDTH_LARGE = 190;
	int TEXT_FIELDS_WIDTH_MINI = 115;
	...
	String MINI_ISIKA_LOGO = "Mini_Isika_logo.png";

	// *******************BUTTONS********************
	String SETTINGS_BUTTON = "Settings";
	String MODIFY_BUTTON = "Modify";
	...
	String DELETE_INTERN_BUTTON = "Remove";
	...
	String SETTINGS_LABEL = "Change account's informations";
	String CHANGE_NAME_LABEL = "Change name";
	String CHANGE_FORENAME_LABEL = "Change forename";
	String CHANGE_EMAIL_LABEL = "Change E-mail";
	String CHANGE_PASSWORD_LABEL = "Change password";
