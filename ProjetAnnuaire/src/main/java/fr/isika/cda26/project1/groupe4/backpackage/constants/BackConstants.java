...
// ********************************** SIZES OF OBJECTS ***********************************************
	int INTERN_SIZE = 2*(NAME_SIZE + FORENAME_SIZE + LOCATION_SIZE + PROMOTION_SIZE) + 4*(PROMOTION_YEAR_SIZE + RIGHTNODE_POSITION_SIZE + LEFTNODE_POSITION_SIZE);
	int[] INTERN_DB_MASK = new int[] { 
			0,
			NAME_SIZE, 
			NAME_SIZE + FORENAME_SIZE,
			NAME_SIZE + FORENAME_SIZE + LOCATION_SIZE, 
			NAME_SIZE + FORENAME_SIZE + LOCATION_SIZE + PROMOTION_SIZE,
			NAME_SIZE + FORENAME_SIZE + LOCATION_SIZE + PROMOTION_SIZE + PROMOTION_YEAR_SIZE, 
			NAME_SIZE + FORENAME_SIZE + LOCATION_SIZE + PROMOTION_SIZE + PROMOTION_YEAR_SIZE + RIGHTNODE_POSITION_SIZE
			};
}
